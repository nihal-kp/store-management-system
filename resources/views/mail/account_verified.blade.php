                           ...
                           <td style="width:100%;float: left;">
                              <table width="100%" cellpadding="5" border="0" style="border: none;">
                                 <tbody>
                                    <tr style="width: 100%">
                                       <th style="">
                                          {{-- <img src="{{asset('assets/front/images/unnamed1.png')}}" style="  /* float: left; */    width: 75px;    margin-top: 20px;  "> --}}
                                       </th>
                                    </tr>
                                 </tbody>
                              </table>
                        ...
                        <tr style="width: 100%;">
                           <td style="width:100%;float: left;">
                              <table width="100%" cellpadding="5" border="0" style="border: none;">
                                 <tbody>
                                    <tr style="width: 100%">
                                       <th style="font-size:19px;line-height: 28px;font-weight: 600;color: #000;padding: 5px 0px;text-align:center;">Hi {{ ucfirst($customer->name) }},</th>
                                    </tr>
                                    <tr style="width: 100%">
                                        <th style="font-size:14px;line-height: 25px;font-weight:400;color:#504848;padding: 5px 0px;text-align:center;"> Your account with Stores has been verified!</th>
                                    </tr>
                                 </tbody>
                              </table>
                           </td>
