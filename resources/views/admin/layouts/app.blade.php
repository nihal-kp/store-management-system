...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>@yield('title') | Admin Console | Store Management System</title>
    ...
    <meta property="og:title" content="@yield('title') | Admin Console | Store Management System">
    <meta property="og:description" content="Store Management System">
    <meta property="og:image" content="{{asset('images/store-og.jpg') }}">
    <!--begin::Fonts-->
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center  header-mobile-fixed ">
        ...
        <a href="{{route('admin.home')}}">
                       <h2 style="    color: #fff;   font-size: 25px;    font-weight: 700;">store_management_system.com</h2>
        </a>
        <!--end::Logo-->
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto " id="kt_brand">
                    <!--begin::Logo-->
                    <a href="{{route('admin.home')}}" class="brand-logo" style="    text-align: center;
    width: 100%;    padding-top: 0px;">
                        <h2 style="color: #fff;font-size: 19px;font-weight: 700;">Store Management System</h2>
                    </a>
                    <!--end::Logo-->
