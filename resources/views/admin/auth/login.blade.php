...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login | Admin Console | Store Management System</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="author" content="" />
    <meta name="robots" content="noindex, nofollow" />
    <meta name="keywords" content="Store Management System">
    <meta name="description" content="Store Management System." />
    <meta property="og:title" content="Login | Admin Console | Store Management System">
    <meta property="og:description" content="Store Management System">
    <meta property="og:image" content="{{asset('images/store-og.webp') }}">
    <!--begin::Fonts-->
...
<link href="{{ asset('assets/css/themes/layout/header/menu/light.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/> -->
    ...
    <link rel="shortcut icon" href="{{ asset('images/favi-icon.webp') }}" />
...
<body id="kt_body"
    ...
    <div class="d-flex flex-column flex-lg-row flex-row-fluid text-center"
        ...
        <!--begin:Aside-->
        <div class="d-flex w-100 flex-center p-15" style="background: #133766;">
            <div class="login-wrapper">
                <!--begin:Aside Content-->
                <div class="text-dark-75">
                    <a href="#">
                       <h2 style="    color: #fff;   font-size: 50px;    font-weight: 700;">Store Management System
</h2>
                    </a>
	<h3 class="mb-8 mt-22 font-weight-bold" style="color:#fff !important">Welcome to the Admin Console of Store Management System</h3>
					<p class="mb-15 text-muted font-weight-bold" style="color:#fff !important">
						Powered by Nihal K P.
					</p>
                </div>
                <!--end:Aside Content-->
            </div>
